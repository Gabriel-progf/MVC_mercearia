...
class DaoEstoque:
    ...
    def ler(cls):
        ...
        est = [Estoque(Produtos(i[0],i[1],i[2]), int(i[3])) for i in cls.estoque]
...
class DaoFornecedor:
    ...
    def ler(cls):
        with open('fornecedores.txt', 'r') as arq:
            ...
            cls.forncedores = list(map(lambda x: x.split('|'), cls.fornecedores))
            
            
            fornec = [Fornecedor(i[0], i[1], i[2], i[3]) for i  in cls.forncedores]
...
class DaoPessoa:
    ...
    def ler(cls):
        with open('clientes.txt', 'r') as arq:
            ...
            cli = [Pessoa(i[0], i[1], i[2], i[3], i[4]) for i in cls.clientes]
...
class DaoFuncionario:
    ...
    def ler(cls):
        with open('funcionarios.txt', 'r') as arq:
            ...
            func = [Funcionario(i[0], i[1], i[2], i[3], i[4], i[5]) for i in cls.funcionarios]
