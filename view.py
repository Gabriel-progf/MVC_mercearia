...
criarArquivos(
    "categoria.txt", "estoque.txt", "venda.txt",
    "clientes.txt", "fornecedores.txt", "funcionarios.txt"
)
        ...
        if local == 1:
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    cat.alterarProduto(nomeAlterar, nome,
                                       preco, categoria, quantidade)
                elif decidir == 4:
                    cat.mostrarEstoque()
                else:
                    break
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    novoCategoria = input(
                        'Digite a nova categoria fornecida: \n')

                    cat.alterarFornecedor(
                        nomeAlterar, novoNome, novoCnpj, novoTelefone, novoCategoria)
                elif decidir == 4:
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    cat.cadastrarFuncionario(
                        clt, nome, telefone, cpf, email, endereco)
                elif decidir == 2:
                    funcionario = input(
                        "Digite o funcionario que deseja remover: \n")
                    ...
                    novoEndereco = input(
                        "Digite o novo endereço do funcionario: \n")
